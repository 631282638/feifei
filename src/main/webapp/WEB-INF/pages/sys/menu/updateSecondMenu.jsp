...
<html id="emle">
  ...
  <legend>二级菜单修改</legend>
   ...
   <form class="layui-form" action="sys/second/menu/update.do" method="post">  
  ...
  <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text"  id="m_url" name="m_url" required  lay-verify="required" value="${url}"  placeholder="请输入路径"   autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
...
var backButtonUp = function(){
	window.location.href = "sys/second/menu/show.do?p_id="+'${p_id}';
};
</script>
</body>
