...
<html id="emle">
  ...
  <legend>二级菜单添加</legend>
   ...
   <form class="layui-form" action="sys/second/menu/add.do" method="post">  
     <input type="hidden" name="p_id" value="${p_id}"/>
  <div class="layui-form-item">
    <label class="layui-form-label">菜单标题</label>
    <div class="layui-input-block">
      <input type="text" id="m_title" name="m_title" required  lay-verify="required" placeholder="请输入标题"    autocomplete="off" class="layui-input">
    </div>
  </div> 
  <div class="layui-form-item">
    <label class="layui-form-label">菜单标签</label>
    <div class="layui-input-inline">
      <input type="text"   id="m_icon" name="m_icon" required  lay-verify="required"  placeholder="请输入图标" autocomplete="off" class="layui-input">
    </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text"  id="m_url" name="m_url" required  lay-verify="required"  placeholder="请输入路径"   autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
...
var backButtonUp = function(){
	window.location.href = "sys/second/menu/show.do?p_id="+'${pid}';
};
</script>
</body>
