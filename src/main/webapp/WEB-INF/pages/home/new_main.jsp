...
<html id="emle">
  ...
  <body class="ydob">
	...
	<td class="cool_icon_css"><div class="cool_inco_ct" onclick="contentsShow(-1,-1,'coolhome/bg.do')" ><i class="fa fa-bars"></i></div></td>
	<td class="cool_title_css">开发平台</td>
	<td class="cool_user_css">hi<span style="font-size:20px;color:#ef4136;border-bottom:1px dashed #f00;">&nbsp;${sessionScope.user_name}&nbsp;</span>欢迎您 
	  <a onclick="logOff()"><span class="cool_user_logout">&nbsp;&nbsp;<i class='fa fa-power-off'></i> 注销</span></a></td>
	</tr>
	</table>
	</div>
